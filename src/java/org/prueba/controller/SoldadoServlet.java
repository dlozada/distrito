...
public class SoldadoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            soldado.setApellidos(apellidos);
            soldado.setNombres("DAVID");
            soldado.setIdcompania(new Compania(1));
            soldado.setIdcuerpo(new CuerpoEjercito(1));
            soldado.setDepto("cauca");
            soldado.setCiudad("popayan");
            
           
            
            pruebaDAO.guardar(soldado);
